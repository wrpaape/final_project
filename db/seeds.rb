...
[most_contracts_crop.name, greatest_acreage_crop.name]
"""
...
|[unprofitable_client.name, unprofitable_farmer.name]|
"""
def answer_the_red_line
  ...
  farmers_w_income.each_with_index do |farmer, index|
    ...
    if profit < 0
      ...
      return [unprofitable_client.name, unprofitable_farmer.name]
    end
  end
end
