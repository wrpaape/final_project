...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { crop_id: @field.crop_id, farm_id: @field.farm_id, size: @field.size, upkeep: @field.upkeep }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { crop_id: @field.crop_id, farm_id: @field.farm_id, size: @field.size, upkeep: @field.upkeep }
    assert_redirected_to field_path(assigns(:field))
  end
