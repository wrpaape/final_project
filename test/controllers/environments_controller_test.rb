...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { description: @environment.description, models: @environment.models, title: @environment.title }
    end
  ...
  test "should update environment" do
    patch :update, id: @environment, environment: { description: @environment.description, models: @environment.models, title: @environment.title }
    assert_redirected_to environment_path(assigns(:environment))
  end
